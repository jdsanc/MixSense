...
uv run python mixsense-skills/chem-nmr-mixture-analysis/scripts/nmr_predict_candidates.py \
...
```bash
# Env: mixsense
uv run python mixsense-skills/chem-nmr-mixture-analysis/scripts/nmr_deconvolve.py \
  crude.csv candidates/borneol.csv candidates/isoborneol.csv \
  --protons 18 18 \
