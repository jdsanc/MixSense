---
name: skill-search
description: Discover available NMR Analysis skills by scanning .agents/skills/ frontmatter. Use this to find skills relevant to a research task.
...
3. If no search term was provided, display the full list organized by category prefix:
   - `chem-`: NMR analysis and data utilities
   - `drug-`: Database
